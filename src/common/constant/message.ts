...
export const USER_FORBIDEN_COMPANY: string =
  'Không thể thao tác ! Tổ chức này không thuộc quyền quản lý của bạn !';
export const NOT_PERMISSION_SHARE: string =
  'Bạn không có quyền sử dụng chức năng này !';
export const ADD_TICKET_SUCCESS: string =
  'Thêm thí sinh vào cuộc thi thành công !';
export const ADD_NEW_UCO_SUCCESS: string =
  'Chia sẻ quyền quản lý cuộc thi thành công !';
export const ADD_NEW_UCA_SUCCESS: string =
  'Chia sẻ quyền quản lý thí sinh thành công !';
export const ADD_NEW_UCA_FAIL: string =
  'Chia sẻ quyền quản lý thí sinh không thành công !';
export const ADD_NEW_ASCO_FAIL: string = 'Thêm thí sinh vào cuộc thi thất bại';

export const USER_CREATE_ROOM_NOT_FOUND: string =
  'Tài khoản của bạn không tồn tại !';
export const USER_CONNECT_ROOM_NOT_FOUND: string =
...
export const DUBLICATE_ID_USER: string =
...
export const GET_GROUP_CHAT_SUCCESS: string =
  'Lấy danh sách nhóm chát thành công !';
export const GET_ROOM_SUCCESS: string = 'Lấy danh sách phòng thành công !';
export const ADD_NEW_FRIEND_SUCCESS: string = 'Thêm bạn bè thành công !';
export const USER_REVEICE_NOT_FOUND: string =
  'Thông tin người nhận không tồn tại ';
export const FRIEND_EXIST: string =
  'Người trong danh sách đã được thêm vào danh sách bạn bè !';
export const THEY_NOT_FRIEND: string = 'Tài khoản không phải bạn bè';
export const CANCEL_FRIEND_SUCCESS: string = 'Hủy kết bạn thành công';
export const GET_UNKNOW_PEOPLE_SUCCESS: string =
