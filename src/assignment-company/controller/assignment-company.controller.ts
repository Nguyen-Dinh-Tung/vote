...
export class AssignmentCompanyController {
  constructor(
    private readonly assignmentCompanyService: AssignmentCompanyService,
  ) {}

  @Post()
  async create(
    @Body() createAssignmentCompanyDto: CreateAssignmentCompanyDto,
    @Res() res: Response,
  ) {
    try {
      return await this.assignmentCompanyService.create(
        createAssignmentCompanyDto,
      );
    } catch (e) {
      if (e) console.log(e);
    }
  ...
  async findAll(
    ...
    try {
      return await this.assignmentCompanyService.findAll(
        res,
        param.page,
        param.id,
        query.isActive,
  ...
  async update(
    ...
    try {
      return this.assignmentCompanyService.update(
        id,
        updateAssignmentCompanyDto,
        res,
      );
    } catch (e) {
      if (e) console.log(e);
